...
def test_2_add_new_recipes(self):
    r = request.post(Test_RecipeAPI._get_url("add_recipe"),
                     obj={data.RECIPE_OBJ})
...
def test_3_get_new_recipe(self):
    cookie_name = data.RECIPE_OBJ.cookie_name
